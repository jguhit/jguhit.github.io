...
class eth_tx(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.checkBox_rst_logic.stateChanged.connect(lambda: self.print_str('rst_logic='+\
        ...
        self.checkBox_rst_gen_tdim.stateChanged.connect(lambda: self.print_str('rst_gen_tdim='+\
        ...
        self.checkBox_rst_gen_tmsm.stateChanged.connect(lambda: self.print_str('rst_gen_tmsm='+\
        ...
        self.checkBox_rst_gen_tckm.stateChanged.connect(lambda: self.print_str('rst_gen_tckm='+\
        ...
        self.checkBox_rst_gen_ttco.stateChanged.connect(lambda: self.print_str('rst_gen_ttco='+\
        ...
        self.checkBox_rst_chk_tdo_m.stateChanged.connect(lambda: self.print_str('rst_chk_tdo_m='+\
        ...
        self.checkBox_errcnt_inj.stateChanged.connect(lambda: self.print_str('errcnt_inj='+\
        ...
        self.checkBox_mbt_trigger_minisas.stateChanged.connect(lambda: self.print_str('mbt_trigger_minisas='+\
        ...
        self.checkBox_rst_clkdiv.stateChanged.connect(lambda: self.print_str('rst_clkdiv='+\
        ...
        self.lineEdit_jtag_daisychain.editingFinished.connect(lambda: self.print_str('jtag_daisychain='+\
        ...
        self.lineEdit_rst_chk_tms_s.editingFinished.connect(lambda: self.print_str('rst_chk_tms_s='+\
        ...
        self.lineEdit_rst_chk_tck_s.editingFinished.connect(lambda: self.print_str('rst_chk_tck_s='+\
        ...
        self.lineEdit_errcnt_rst4ch.editingFinished.connect(lambda: self.print_str('errcnt_rst4ch='+\
        ...
        self.lineEdit_rst_chk_elinkttc.editingFinished.connect(lambda: self.print_str('rst_chk_elinkttc='+\
    ...
    def loop_jtag_start(self):
        if self.checkBox_loopjtag.isChecked():
            ...
            self.worker = Worker_loopjtag(self)
    ...
    def vio_update(self):
        self.lineEdit_jtag_daisychain.setText(bin_to_hex(self.eth.jtag_daisychain[0],5))
        print("JTAG daisy chain now = "+self.eth.jtag_daisychain[0])
...
class Worker_loopjtag(QObject):
    ...
    def run(self): 
        print("Start to loop jtag randomly!") 
        while(self.eth_tx.jtaglooping):
            ...
            time.sleep(300)
        self.finished.emit()
        print("Jtag random loop stopped!") 
