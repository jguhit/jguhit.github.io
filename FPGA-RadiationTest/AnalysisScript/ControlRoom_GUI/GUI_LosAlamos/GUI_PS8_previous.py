...
class Worker(QObject):
    ...
    def run(self):
        ...
        while self.MyWindow.processing: 
            ...
            #self.MyWindow.label12.setText("%.5f"%(self.data_ps5[0][0]))
            #self.MyWindow.label13.setText("%.5f"%(self.data_ps5[1][0]))
            #self.MyWindow.label14.setText("%.5f"%(self.data_ps5[2][0]))
            #self.MyWindow.label15.setText("%.5f"%(self.data_ps5[3][0]))
            end = time.time()
...
class MyWindow(QMainWindow): 
    ...
    def initUI(self):
        ...
        self.tab_PS_1_addr8 = QtWidgets.QWidget(self)
        self.tabWidget.addTab(self.tab_PS_1_addr8, "PS1:Addr8")
        self.tab_PS_2_addr5 = QtWidgets.QWidget(self)
        ...
        #plot layout PS5
        self.layoutWidget17 = QtWidgets.QWidget(self)
        ...
        self.layoutWidget19 = QtWidgets.QWidget(self)
    ...
    def gpib_5(self, addr):
        ...
        print("Power supply 5 connected to GPIB")
        with open(PS5_CSM1_txtname, "a") as f:
    ...
    def gpib(self, addr): # dont know if it works yet 
        ...
        print("Power supply 8 connected to GPIB")
        with open(PS8_CSM2_txtname, "a") as f:
    ...
    def graph(self, f1, f2, f3, f4, i1, obj1):
        ...
        with open(PS8_CSM2_csvname, 'a') as csv_file:
    ...
    def graph_5(self, f1_5, f2_5, f3_5, f4_5, i1_5, obj1_5):
        ...
        with open(PS5_CSM1_csvname, 'a') as csv_file:
            fieldnames = ['DateTime','Time_S', 'Volt1_V', 'Volt2_V', 'Curr1_A', 'Curr2_A']
            writer = csv.DictWriter(csv_file, fieldnames=fieldnames)
