...
class eth_rx(object):
            ...
            if self.eth.error_list[i]!=self.label_vio_list[i].text():                                     
                if i==2:
                    ...
                    if self.eth.error_list[2]!='7':
                        ...
                        print("Multiboot count=%d" %(self.eth.mboot_count))
                if i==3:
    ...
    def update_checklist(self):
        ...
        print('error_check_list now ='+checklist_str)
    ...
    def multi_boot(self):
        ...
        for i in range (10):
            print("multi_boot in %d second(s)!"%(10-i))
            time.sleep(1)
        print("multi_boot in progress!")
    ...
    def start_monitor(self):    
        ...
        # Step 3: Create a worker object
        self.worker3 = Worker_error_monitor(self)
        # Step 4: Move worker to the thread
        ...
        while self.eth_rx.processing:
            if self.eth_rx.eth.check_tdo[0] == '1':
                ...
                if self.tdo_error-self.tdo_error_pre>10000:
                    ...
                    print('tdo_error='+str(self.tdo_error))
                    print('tdo_error_pre='+str(self.tdo_error_pre))
                    print("TDO link failed! Now start to check. TTC, TCK and TMS check disabled.")
                    ...
                    for i in range (18):
                        if self.eth_rx.processing:
                            ...
                            print("jtag_daisy_chain="+jtag_daisy_chain)
    ...
    def run(self): 
        ...
        while self.eth_rx.processing:
            ...
            if data_error==1 and self.eth_rx.eth.multiboot_inprogress ==0\
                ...
                print("Massive errors found for %d time(s)!" %(self.prepare_to_multiboot))
            else:
                self.prepare_to_multiboot  = 0
